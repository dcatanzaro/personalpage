...
const StepAmount = () => {
        ...
        portfolio: [
            {
                ...
                technologiesDescription: "HTML5, CSS3, JavaScript, NodeJS, MongoDB, WebSockets, DigitalOcean",
            },
            {
                ...
                images: [
                    {
                        img: "/static/imgs/portfolio/AlegriaPolo/alegriapolo_1.jpg",
                        alt: "AlegriaPolo Imagen 1",
                    },
                    {
                        img: "/static/imgs/portfolio/AlegriaPolo/alegriapolo_2.jpg",
                        alt: "AlegriaPolo Imagen 2",
                    },
                    {
                        img: "/static/imgs/portfolio/AlegriaPolo/alegriapolo_3.jpg",
                        alt: "AlegriaPolo Imagen 3",
                    },
                ],
                technologiesDescription: "HTML5, CSS3, JavaScript, PreactJS, Apache Cordova",
            },
            {
                ...
                images: [
                    {
                        img: "/static/imgs/portfolio/Cambiemos/cambiemos_1.jpg",
                        alt: "Cambiemos Imagen 1",
                    },
                    {
                        img: "/static/imgs/portfolio/Cambiemos/cambiemos_2.jpg",
                        alt: "Cambiemos Imagen 2",
                    },
                    {
                        img: "/static/imgs/portfolio/Cambiemos/cambiemos_3.jpg",
                        alt: "Cambiemos Imagen 3",
                    },
                ],
                technologiesDescription: "HTML5, CSS3, JavaScript, Raspberry Pi con Raspbian",
            },
            {
                ...
                technologiesDescription: "HTML5, CSS3, JavaScript, Canvas, NodeJS, MySQL, WebSockets, DigitalOcean",
            },
            {
                ...
                technologiesDescription: "HTML5, CSS3, JavaScript, NodeJS, MongoDB, AWS",
            },
            ...
            },
            {
                ...
                technologiesDescription: "HTML5, CSS3, JavaScript, PHP, DigitalOcean",
            },

            {
                ...
                technologiesDescription: "HTML5, CSS3, JavaScript, Preact, Apache Cordova",
            },
            {
                ...
                technologiesDescription: "HTML5, CSS3, JavaScript, NodeJS, MongoDB, DigitalOcean",
            },
            {
                ...
                technologiesDescription: "HTML5, CSS3, JavaScript, PHP, Mysql, Google App Engine",
            },
        ],
        companies: [
            {
                ...
                images: [
                    {
                        img: "/static/imgs/portfolio/Digiventures/digiventures.png",
                        alt: "Digiventures",
                    },
                ],
                description: "Definición de Stack Tech, arquitectura y programación.",
            },
            {
                title: "Co-Founder",
                subtitle: "CourseIT",
            ...
            },
            {
                ...
                images: [
                    {
                        img: "/static/imgs/portfolio/MercadoLibre/mercadolibre.jpg",
                        alt: "MercadoLibre",
                    },
                ],
                description: "Trabajé en el area de Customer Experience creando herramientas para los representantes.",
            },
            {
                title: "Frontend Engineer",
                subtitle: "Garbarino",
                images: [
                    {
                        img: "/static/imgs/portfolio/Garbarino/garbarino.jpg",
                        alt: "Garbarino",
                    },
                ],
                description:
        ...
        actualWorks: [
            {
                ...
                images: [
                    {
                        img: "/static/imgs/portfolio/Cafecito/1.png",
                        alt: "Cafecito",
                    },
                ],
                description: "",
    ...
    const { portfolio, companies, actualWorks } = state;
    ...
    return (
        <>
            ...
            <h3 className={style.title}>Trabajos actuales</h3>
            ...
            <h3 className={style.title}>Empresas en las que trabajé</h3>
            ...
            <h3 className={style.title}>Trabajos realizados</h3>
